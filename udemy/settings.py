...
SECRET_KEY = config('SECRET_KEY', default='4=+mo(9z4dw1mg2y+#!7n$()hdbrk+jp^03n#g7s87abp5zcuy')
...
DATABASES = {
    'default': dj_database_url.config(default=config('DATABASE_URL', default='postgres://postgres:postgres@postgres:5432/postgres'))
}
